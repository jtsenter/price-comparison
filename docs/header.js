 ...
 * per page (index → Update Prices + table controls; basket → Print;
...
(function () {
  ...
  function navCluster(active) {
    ...
    // which app.js activates on load. Replaced the retired Price Alerts page.
  ...
  var INDEX_CONTROLS =
    ...
    // Columns chooser moved OUT of the header — it's a table control, so it now
    // lives on the category-tabs row directly above the table (see index.html).
